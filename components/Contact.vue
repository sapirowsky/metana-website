...
<template>
  <div id="contact" class="grid h-max place-items-center">
    <div
      class="container flex h-full flex-col gap-4 px-6 py-4 md:flex-row md:gap-0"
    >
      <div class="flex w-full flex-col justify-around gap-4 p-4 md:w-1/2">
        <div class="hide w-full rounded-md bg-gray-200 dark:bg-gray-900">
      ...
      <div class="h-[40rem] md:w-1/2">
        <iframe
          ...
          class="hide h-full w-full rounded-md"
          title="Map to metana"
